...
import com.reto.torrent.config.audit.AuditEventConverter;
import com.reto.torrent.domain.PersistentAuditEvent;
...
import static com.reto.torrent.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
