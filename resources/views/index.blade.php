...
<head>
  ...
  <title>TorrenteSoftware - Index</title>
...
<body>
  ...
  <audio id="audio" controls>
    <source type="audio/mp3" src="/song/round-one.mp3">
  </audio>

  <!-- ======= Hero Section ======= -->
  <section id="hero">
    <div class="hero-container">
      <a href="index.html" class="hero-logo" data-aos="zoom-in"><img src="/img/TorrenteBlack.png" alt=""></a>
      <h1 data-aos="zoom-in">Bienvenido</h1>
      <h2 data-aos="fade-up">Segundo Reto TorrenteSoftware</h2>
      <a data-aos="fade-up" href="#about" class="btn-get-started scrollto song">Que inicie el reto</a>
    </div>
  </section><!-- End Hero -->
    ...
    <div class="container">
      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul class="nav-inner">
          ...
          <li class="nav-logo"><a href="index.html"><img src="/img/logo.png" alt="" class="img-fluid"></a></li>
    ...
    <div class="footer-top">
      ...
      <div class="container">
        ...
        <div class="row justify-content-center">
          <div class="col-lg-6">
            <a href="#header" class="scrollto footer-logo"><img src="assets/img/TorrenteWhite.png" alt=""></a>
            <h3>TorrenteSoftware</h3>
